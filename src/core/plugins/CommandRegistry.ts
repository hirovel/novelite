...
export class CommandRegistry {
  ...
  private aliases: Map<string, string> = new Map([
    ...
    ['split:swap-panes', 'split-view.swap'],
    ['split-view.swap-panes', 'split-view.swap'],
    ['literary:format-chinese', 'typography.format-paragraphs'],
    ['typography.format-chinese', 'typography.format-paragraphs'],
